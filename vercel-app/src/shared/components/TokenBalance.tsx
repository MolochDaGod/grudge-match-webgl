...
import { GbuxTokenService, TokenBalance as TokenBalanceType } from '@/shared/services/GbuxTokenService';
...
export default function TokenBalance() {
  ...
  const gbuxService = useMemo(() => new GbuxTokenService(connection), [connection]);
